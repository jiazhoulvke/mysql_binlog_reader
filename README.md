...
Usage of mysql_binlog_reader:
      ...
      --exclude-json-fields string     exclude json fields (default "column_count,binlog_file,row_type,server_id,ts")
  ...
  -F, --output-format string           output format. supported format: text,json (default "text")
      --show-changed-data              show changed data in json
  -A, --start-datetime string          start reading the binlog at first event having a datetime. example: "2006-01-02 15:04:05"
